                    ...
                    <div>
                        <aside id="sidenav-main"
                            ...
                            <div class="sidenav-header"><i
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item"><a class="nav-link" href={{ Route('Lecturer_Dashboard') }}><i
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            href={{ Route('Lecturer_Applications') }}><i
                                                ...
                                                Tests</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href={{ Route('sick_applications') }}><i
                    ...
                    <div style="padding-left: 0px;margin-top: 50px;margin-left: 0px;">
                        <form
                            ...
                            <div class="input-group" style="padding-bottom: 20px;height: 60px;width: 300px;"><span
                                    ...
                                    type="number" name="student_Number" placeholder={{ $user['lecturerId'] }}
                                    disabled=""></div>
                            <div class="input-group" style="padding-bottom: 20px;height: 60px;width: 300px;"><span
                                    class="input-group-text"><i class="icon-envelope text-muted"></i></span><input
                                    class="form-control" type="email"
                                    placeholder={{ $user['lecturerId'] . '@tut4life.ac.za' }} name="user_Email"
                                    disabled=""></div>
                        </form>
                    </div>
                </div>
