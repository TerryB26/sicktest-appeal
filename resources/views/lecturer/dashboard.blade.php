                    ...
                    <div class="col-md-6" style="padding-right: 0px;margin-right: 0px;margin-left: 200px;">
                        <div class="text-center">
                            <h1 class="text-center"
                                style="margin-top: 30px;font-family: 'Alegreya Sans SC', sans-serif;font-weight: bold;color: var(--bs-link-hover-color);margin-bottom: -4px;">
                                Dashboard</h1>
                                ...
                                <div class="col" style="margin-left: 25px;">
                                    <h1 class="text-start"
                                        ...
                                        <span class="text-muted" style="margin-right: 150px;font-size: 25px;">
                                            {{ $user['courses'][0]['name']." Lecturer" }}
                                        </span>
                                        <button
                                            class="btn btn-outline-primary border rounded-pill shadow" type="button"
                                            href={{ Route('Lecturer_History') }}>View Application History</button>
                                        <a href={{ Route('pastTest') }}>
                                            <button class="btn btn-outline-primary border rounded-pill shadow"
                                                type="button" style="margin-right: 30px;margin-top: 10px;">Create
                                                Previous Test</button>
                                        </a>
                                        <a href={{ Route('Create_Test') }}>
                                            <button class="btn btn-outline-primary border rounded-pill shadow"
                                                type="button" style="margin-right: 120px;margin-top: 10px;">Create
                                                Sick Test</button>
                                        </a>
                                        <a href={{ Route('Lecturer_Signout') }}>
                                            <button class="btn btn-outline-primary border rounded-pill shadow"
