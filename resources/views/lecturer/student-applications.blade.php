                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item"><a class="nav-link active"
                                                href={{ Route('sick_applications') }}><i
                                                    class="fa fa-hospital-o text-light active icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"></i><span
                                                    class="nav-link-text ms-1"
                        ...
                        <div style="padding-left: 0px;margin-top: 50px;margin-left: 0px;">
                            <div class="card shadow" style="font-family: 'Alegreya Sans SC', sans-serif;">
                                <div class="card-header text-center py-3">
                                    <p class="text-primary m-0 fw-bold">Sick Test Applications&nbsp;</p>
                                </div>
                                <div class="card-body">
                                                ...
                                                @foreach ($sickTests as $sickTest)
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            {{ $sickTest['sickTestInfo']['name'] }}</td>
                                                        <td
                                                            style="margin-right: -31px;padding-right: 0px;text-align: center;">
                                                            {{ $sickTest['sickTestInfo']['date'] }}</td>
                                                        <td style="text-align: center;">
                                                            {{ $sickTest['student']['email'] }}</td>
                                                        <td style="text-align: center;">
                                                            <span>
                                                                <a class="btn btn-outline-primary btn-sm border rounded-pill border-primary"
                                                                    role="button"
                                                                    href={{ Route('Application_View', [
                                                                        'studentName' => $sickTest['student']['name'],
                                                                        'studentNumber' => $sickTest['student']['studentId'],
                                                                        'studentEmail' => $sickTest['student']['email'],
                                                                        'reason' => $sickTest['reason'],
                                                                        'applicationId' => $sickTest['applicationId'],
                                                                        'status' =>$sickTest['status'],
                                                                    ]) }}>View
                                                                    Application</a>
                                                            </span>
                                                        </td>
