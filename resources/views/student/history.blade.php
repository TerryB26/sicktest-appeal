                            ...
                            <aside id="sidenav-main-1"
                                ...
                                <div class="sidenav-header"><i
                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href={{ Route('Student_History') }}><i
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                href={{ Route('Student_Application') }}><i
                                                    ...
                                                    class="nav-link-text ms-1"
                                                    style="font-family: 'Alegreya Sans SC', sans-serif;">Apply For Sicktest</span></a></li>
                                            ...
                                            <table class="table my-0" id="dataTable">
                                                ...
                                                <tbody>
                                                    @foreach ($applications as $application)
                                                        <tr>
                                                            <td style="text-align: center;">{{ $application['sickTestInfo']['name'] }}</td>
                                                            <td
                                                                style="margin-right: 0px;padding-right: 0px;text-align: center;">
                                                                {{ $application['sickTestInfo']['venue'] }}</td>
                                                                <td style="text-align: center;">{{ $application['sickTestInfo']['type']." Test" }}</td>
                                                            <td style="text-align: center;">{{ $application['date'] }}</td>
                                                            <td style="text-align: center;">{{ Str::ucfirst($application['status']) }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
