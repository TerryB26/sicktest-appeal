    ...
    <section>
        <div class="container justify-content-center align-items-center align-content-center" style="padding: 40px;">
            ...
            @if (Session::has('failure') || Session::has('success'))
                <div class="alert alert-{{ Session::has('failure') ? 'danger' : 'success' }} border rounded-pill alert-dismissible"
                    role="alert">
                    <button class="btn-close" type="button" aria-label="Close"
                        data-bs-dismiss="alert"></button><span><strong>{{ Session::has('failure') ? Session::get('failure') : Session::get('success') }}</strong>.</span>
                </div>
            @endif
                ...
                <div class="col text-center d-flex justify-content-center align-items-center align-content-center align-self-center"
                    ...
                    <form style="font-family: 'Alegreya Sans SC', sans-serif;" action="" method="POST">
                        ...
                        <div class="input-group" style="padding-bottom: 20px;height: 60px;"><span
                                ...
                                class="form-select" name="module_name" >
                        ...
                        <div class="input-group" style="padding-bottom: 20px;height: 60px;"><span
                                ...
                                <option value="semester">Semester Test</option>
                                <option value="web">Webtest</option>
                        ...
                        {{-- <div class="input-group" style="padding-bottom: 20px;height: 60px;"><span class="input-group-text"><i class="icon-location-pin text-muted"></i></span><input class="form-control" type="text" name="test_venue" placeholder="Venue"></div>
